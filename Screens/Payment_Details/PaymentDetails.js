                                        ...
                                        .then((responseData) => {
                                         //Alert.alert("KK",JSON.stringify(data))
                                          ...
                                          console.log("Response:",responseData);
                                              ...
                                              firebase.database().ref('CoinTransaction').push({ coins:this.state.coin ,createdAt:firebase.database.ServerValue.TIMESTAMP,frinedId:"", planType:this.state.planType, trxType:'DEBIT',userId:this.state.user_id,createdAt:firebase.database.ServerValue.TIMESTAMP,createdBy:this.state.user_id,status:1,updatedAt:firebase.database.ServerValue.TIMESTAMP,updatedBy:this.state.user_id}).then(()=>{
