  ...
  componentDidMount()
  {
    ...
    AsyncStorage.getItem('isAppKill').then((value) => {
     ...
     setTimeout(() => {
       ...
       {
         AsyncStorage.multiGet(['gymId','checkinGymKey','userKeyInGym','barcodeId','barcodeURL','gymName','afterCheckInUserCoins','checkinKey'], (err, stores) =>
           {
           ...
           setTimeout(()=>{
             ...
             const resetAction = NavigationActions.reset({
                     index: 0,
                     actions: [NavigationActions.navigate({ routeName: 'Scanner',params:{comingFrom:'splash',checkinKey:this.state.checkinKey,afterCheckInUserCoins:this.state.afterCheckInUserCoins,gymId:this.state.gymId,checkinGymKey:this.state.checkinGymKey,userKeyInGym:this.state.userKeyInGym,barcodeId:this.state.barcodeId,barcodeURL:this.state.barcodeURL,gymName:this.state.gymName} })],
                   });
