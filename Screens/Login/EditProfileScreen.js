...
class EditProfileScreen extends Component {
  ...
  componentDidMount() {
    ...
    AsyncStorage.getItem("emergencyContactName")
      .then(value => {
        this.setState({ emergencyContactName: value });
      })
      .done();

    AsyncStorage.getItem("emergencyContactNumber")
      .then(value => {
  ...
  onChangeDateData(date) {
    ...
    var dateChecking = moment(formate_change, "DD-MM-YYYY").format(
      "YYYY-MM-DD"
    );
        ...
        if (this.state.profileImage !== "placeholder_img") {
                ...
                .then(url => {
                  ...
                  // }
                    ...
                    if (
                      ...
                      this.state.emergencyContactNumber !== null
                    ) {
          ...
          //with out selecting profile image
            ...
            var CurrentuserId = firebase
              ...
              .child(this.state.user_id);
            console.log(
              "With out image url this.state.user_id",
              this.state.user_id
            );
            if (fname === "") {
              this.setState({ isConfirm: false });
            ...
            // }
              ...
              if (
                ...
                Alert.alert(
                  Strings.gymonkee,
                  "Profile Updated Successfully..",
                  [{ text: "OK", onPress: () => this._goToProfileScreen() }]
                );
              } else {
                CurrentuserId.update({
                  firstname: this.state.fname,
        ...
        //With out image url
          ...
          // }
            ...
            if (
              ...
              Alert.alert(Strings.gymonkee, "Profile Updated Successfully..", [
                { text: "OK", onPress: () => this._goToProfileScreen() }
              ]);
            } else {
              CurrentuserId.update({
          ...
          >
            ...
            >
              ...
              <View
                style={{
                  flex: 0.5,
                  marginTop: DeviceInfo.getModel() === ModelIphoneX ? 38 : 32,
                  borderBottomWidth: 1,
                  borderBottomColor:
              ...
              >
                <ModalDropdown
                  ...
                  onSelect={(idx, value) =>
                    this._dropdownState_onSelect(idx, value)
                  }
            ...
            >
              <View
                style={{
                  ...
                  marginTop: 15,
                  borderBottomWidth: 1,
                  borderBottomColor: Colors.white_underline
                }}
              >
