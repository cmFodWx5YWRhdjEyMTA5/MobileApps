...
_loaderOff() {
  ...
  static navigationOptions = ({navigation, screenProps}) => {
     ...
     return {
           ...
           <Text style={{color: '#ffffff',alignSelf: 'center',textAlign:'center',fontSize:18,justifyContent:'center',fontWeight:'400',fontFamily:Fonts.SFU_REGULAR,paddingRight:50}}>Help</Text>
           </View>
           </View>
