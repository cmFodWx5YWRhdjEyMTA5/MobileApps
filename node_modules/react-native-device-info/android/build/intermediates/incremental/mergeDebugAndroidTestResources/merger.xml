...
<attr format="boolean" name="circleCrop"/>
  ...
  </style><style name="Theme"/></file><file name="preferences" path="/Users/macbook/.android/build-cache/0794b3431a1085ffb0128c6d38188465bde39e39/output/res/xml/preferences.xml" qualifiers="" type="xml"/></source></dataSet><dataSet config="debug" from-dependency="true" generated-set="debug$Generated"><source path="/Volumes/DataDrive2/Gymonkee_2_May/node_modules/react-native-device-info/android/build/intermediates/bundles/debug/res"/></dataSet><dataSet config="main" generated-set="main$Generated"><source path="/Volumes/DataDrive2/Gymonkee_2_May/node_modules/react-native-device-info/android/src/androidTest/res"/><source path="/Volumes/DataDrive2/Gymonkee_2_May/node_modules/react-native-device-info/android/build/generated/res/rs/androidTest/debug"/><source path="/Volumes/DataDrive2/Gymonkee_2_May/node_modules/react-native-device-info/android/build/generated/res/resValues/androidTest/debug"/></dataSet><mergedItems><configuration qualifiers=""><declare-styleable name="AlertDialog"><attr name="android:layout"/><attr format="reference" name="buttonPanelSideLayout"/><attr format="reference" name="listLayout"/><attr format="reference" name="multiChoiceItemLayout"/><attr format="reference" name="singleChoiceItemLayout"/><attr format="reference" name="listItemLayout"/></declare-styleable><declare-styleable name="SimpleDraweeView"><attr format="string" name="actualImageUri"/><attr format="reference" name="actualImageResource"/></declare-styleable><declare-styleable name="GenericDraweeHierarchy"><attr format="integer" name="fadeDuration"/><attr format="float" name="viewAspectRatio"/><attr format="reference" name="placeholderImage"/><attr name="placeholderImageScaleType">
      <enum name="none" value="-1"/>
      <enum name="fitXY" value="0"/>
      <enum name="fitStart" value="1"/>
      <enum name="fitCenter" value="2"/>
